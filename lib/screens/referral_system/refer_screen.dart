                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _buildStepItem(
                              ...
                              description:
                                  'Send your unique referral code to friends via messages, email, or social media.',
                            ),
                            const SizedBox(height: 12),
                            _buildStepItem(
                              step: 2,
                              ...
                              description:
                                  'Your friend downloads Voyant and signs up using your referral code.',
                            ),
                            const SizedBox(height: 12),
                            _buildStepItem(
                              step: 3,
                              title: 'Earn Rewards',
                              description:
                                  'Both you and your friend receive bonus travel credits and exclusive perks!',
                            ),
                          ],
                        ),
                      ),
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 12),
                            const Text(
                              '• Rewards are credited after your friend completes their first booking\n'
                              '• There\'s no limit to how many friends you can refer\n'
                              '• Credits are valid for 1 year from the date of issuance\n'
                              '• Fraudulent referrals may result in account suspension\n'
                              '• Rewards can be used for any bookings on Voyant',
                              style: TextStyle(
                                fontSize: 12,
                                color: Colors.white70,
                                height: 1.6,
